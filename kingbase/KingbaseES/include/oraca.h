...
#define  ORASTFANY 3                 /* = always save                       */
  ...
  /* max length of ORACA last sql */
#define MAX_LENGTH_SQL 70
  /* text */ char  orastxtc[MAX_LENGTH_SQL];
...
struct oraca_t *ESQLConnectionGetOraca(void);

#ifndef KINGBASE_ESQL_INTERNAL
#define oraca (*ESQLConnectionGetOraca())
#endif
